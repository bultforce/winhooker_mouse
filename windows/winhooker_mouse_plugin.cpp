...
const char WinhookerMousePlugin::kOnLogCallbackMethod[] = "onLog";
const char WinhookerMousePlugin::kGetVirtualKeyMapMethod[] = "getVirtualKeyMap";
...
// static
void WinhookerMousePlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "winhooker_mouse",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<WinhookerMousePlugin>();
  ...
  channel->SetMethodCallHandler(
    ...
    eventChannel =
        std::make_unique<flutter::EventChannel<flutter::EncodableValue>>(
            registrar->messenger(), "win_tracker_mouse",
            &flutter::StandardMethodCodec::GetInstance(
...
WinhookerMousePlugin::WinhookerMousePlugin() {}

WinhookerMousePlugin::~WinhookerMousePlugin() {KeyboardHookDisable();}

void WinhookerMousePlugin::HandleMethodCall(
...
void WinhookerMousePlugin::showText(LPCTSTR text) {
...
void showText(LPCTSTR text, int behavior) {
  WinhookerMousePlugin::showText(text);
}
