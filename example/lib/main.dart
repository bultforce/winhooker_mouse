...
class _MyAppState extends State<MyApp> {
  ...
  final _winHooker = WinhookerMouse();
              ...
              child: Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    color: Colors.blue,
                    onPressed: ()async{
                      keyBoardStreamSubscription =_winhooker.streamMouseHook().listen((event) {
                        print("$event");
                      });
                    },
